...
(function () {
  ...
  (function computeBasePath() {
    ...
    if (isGitHub) {
      ...
      // Local server or custom domain: base is always the site root (origin).
      // We never need a sub-path prefix on localhost or a custom domain —
      // the site lives at the root, so absolute paths like /product/... resolve correctly.
      window.HFG_BASE = origin;
    }
  })();
